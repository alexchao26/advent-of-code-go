...
func main() {
	...
	// fmt.Println("index matches, san then you", indexOfSanPlanet, indexOfYouPlanet)
...
func returnMapOfOrbits(inputSlice []string) map[string]string {
	...
	// fmt.Println("length of inputs is", len(inputSlice))
	return resultMap
}
...
func recurseToCOM(mapOfOrbits map[string]string, planet string) []string {
	...
	for {
		...
		// fmt.Println("recursing w/ planet", planet, "is inside", planetString, ok)
		if ok {
	...
	// fmt.Println("slice is", planetsToComSlice)
